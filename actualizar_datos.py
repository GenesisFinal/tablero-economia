...
def reconstruct_and_order_dataset():
    ...
    for d, p in zip(mep_s.get("dates", []), mep_s.get("prices", [])):
        fx_mep[d[:7]] = float(p)
    fx_benchmarks = {
        "2003-01": 3.15, "2003-06": 2.80, "2003-12": 2.95,
        "2004-01": 2.92, "2004-06": 2.96, "2004-12": 2.98,
        "2005-01": 2.96, "2005-06": 2.89, "2005-12": 3.03,
        "2006-01": 3.06, "2006-06": 3.08, "2006-12": 3.07,
        "2007-01": 3.10, "2007-06": 3.09, "2007-12": 3.15,
        "2008-01": 3.16, "2008-06": 3.03, "2008-12": 3.45,
        "2009-01": 3.47, "2009-06": 3.80, "2009-12": 3.82,
        "2010-01": 3.83, "2010-06": 3.93, "2010-12": 4.01,
        "2011-01": 4.02, "2011-06": 4.13, "2011-12": 4.75,
        "2012-01": 4.80, "2012-06": 5.90, "2012-12": 6.80,
        "2013-01": 7.40, "2013-06": 8.00, "2013-12": 8.90,
        "2014-01": 11.2, "2014-06": 11.8, "2014-12": 13.2,
        "2015-01": 13.5, "2015-06": 13.3, "2015-12": 14.2,
        "2016-01": 14.3, "2016-06": 15.0, "2016-12": 16.1,
    ...
    def get_fx_rate(ym):
        if ym in fx_mep:
            return fx_mep[ym]
        if ym in fx_benchmarks:
            return fx_benchmarks[ym]
        y = int(ym[:4])
